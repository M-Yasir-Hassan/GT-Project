...
print(business_d)
b=business_d['text'].to_list()
f=food_d['text'].to_list()
print(f)
h=health_d['text'].to_list()
...
# Evaluate
testLabels = ["Food","Food","Food", "Business and Finance","Business and Finance","Business and Finance", "Health and Fitness","Health and Fitness","Health and Fitness"]
# Calculate accuracy
